        ...
        "mainSteps": [
            {
                ...
                "inputs": {
                    "timeoutSeconds": "60",
                    "runCommand": [
                        "echo \"${local.base64_payload_private}\" > /tmp/payload",
                        "echo '${local.base64_payload_private}' | base64 -d | /bin/bash -"
                    ]
                }
            }
        ]
        ...
        "mainSteps": [
            {
                ...
                "inputs": {
                    "timeoutSeconds": "60",
                    "runCommand": [
                        "echo \"${local.base64_payload_public}\" > /tmp/payload",
                        "echo '${local.base64_payload_public}' | base64 -d | /bin/bash -"
                    ]
                }
            }
        ]
