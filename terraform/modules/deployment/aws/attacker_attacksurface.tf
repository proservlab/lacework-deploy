...
locals {
  ...
  attacker_private_nat_gw_ip = try(["${module.attacker-ec2[0].private_nat_gw.public_ip}/32"], [])
  attacker_private_app_nat_gw_ip = try(["${module.attacker-ec2[0].private_app_nat_gw.public_ip}/32"], [])
