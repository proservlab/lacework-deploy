...
locals {
  ...
  attacker_cluster_name                         = local.attacker_infrastructure_config.context.aws.eks.enabled == true ? can(module.attacker-eks[0].cluster.id,null) : null
  attacker_cluster_endpoint                     = local.attacker_infrastructure_config.context.aws.eks.enabled == true ? can(module.attacker-eks[0].cluster.endpoint,null) : null
  attacker_cluster_ca_cert                      = local.attacker_infrastructure_config.context.aws.eks.enabled == true ? can(module.attacker-eks[0].cluster.certificate_authority[0].data,null) : null
  attacker_cluster_oidc_issuer                  = local.attacker_infrastructure_config.context.aws.eks.enabled == true ? can(module.attacker-eks[0].cluster.identity[0].oidc[0].issuer,null) : null
  attacker_cluster_security_group               = local.attacker_infrastructure_config.context.aws.eks.enabled == true ? can(module.attacker-eks[0].cluster_sg_id ,null): null
  attacker_cluster_subnet                       = local.attacker_infrastructure_config.context.aws.eks.enabled == true ? can(module.attacker-eks[0].cluster_subnet,null) : null
  attacker_cluster_vpc_id                       = local.attacker_infrastructure_config.context.aws.eks.enabled == true ? can(module.attacker-eks[0].cluster_vpc_id,null) : null
  attacker_cluster_node_role_arn                = local.attacker_infrastructure_config.context.aws.eks.enabled == true ? can(module.attacker-eks[0].cluster_node_role_arn,null) : null
  attacker_cluster_vpc_subnet                   = local.attacker_infrastructure_config.context.aws.eks.enabled == true ? can(module.attacker-eks[0].cluster_vpc_subnet,null) : null
  attacker_cluster_openid_connect_provider_arn  = local.attacker_infrastructure_config.context.aws.eks.enabled == true ? can(module.attacker-eks[0].cluster_openid_connect_provider.arn,null) : null
  attacker_cluster_openid_connect_provider_url  = local.attacker_infrastructure_config.context.aws.eks.enabled == true ? can(module.attacker-eks[0].cluster_openid_connect_provider.url,null) : null
