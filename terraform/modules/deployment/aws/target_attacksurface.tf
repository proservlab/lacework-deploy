locals {
  ...
  target_private_nat_gw_ip = try(["${module.target-ec2[0].private_nat_gw.address}/32"],[])
  target_private_app_nat_gw_ip = try(["${module.target-ec2[0].private_app_nat_gw.address}/32"],[])
