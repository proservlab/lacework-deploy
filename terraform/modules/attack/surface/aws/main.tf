...
module "ec2-add-trusted-ingress" {
  ...
  trusted_attacker_source       = local.config.context.aws.ec2.add_trusted_ingress.trust_attacker_source == true ? (
    local.config.context.aws.ec2.add_trusted_ingress.trust_attacker_source ? flatten([
  ...
  trusted_target_source         = local.config.context.aws.ec2.add_trusted_ingress.trust_target_source == true ? (
      local.config.context.aws.ec2.add_trusted_ingress.trust_target_source ? flatten([
