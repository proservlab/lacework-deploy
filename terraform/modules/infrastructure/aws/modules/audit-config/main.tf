...
module "aws_cloudtrail" {
  ...
  use_existing_iam_role       = var.use_existing_iam_role == false ? true : true
  iam_role_name               = var.use_existing_iam_role == false ? module.aws_config.iam_role_name : var.iam_role_name
  iam_role_arn                = var.use_existing_iam_role == false ? module.aws_config.iam_role_arn : var.iam_role_arn
  iam_role_external_id        = var.use_existing_iam_role == false ? module.aws_config.external_id : var.iam_role_external_id
