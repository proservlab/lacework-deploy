...
locals {
  ssm_default_tags = {
    ...
    ssm_exec_docker_exploit_log4j = "false"
  ...
  osconfig_default_tags = {
    ...
    osconfig_exec_docker_exploit_log4j = "false"
  ...
  runbook_default_tags = {
    ...
    runbook_deploy_python3_twisted_app_target = "false"
    runbook_exec_docker_log4shell_target = "false"
    runbook_exec_docker_log4sheller = "false"
